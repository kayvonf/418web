...
<div>CMU 15-418/618, Spring 2017</div>
     <div><Mon/Wed/Fri 1:30-2:50pm (Friday sessions are recitations)</div>
...
<div>Office hours: Wed 3-4pm, <br/> Fri 4-5pm (ugrad only), <br/> or by appointment</div>
...
<div>GHC 9125</div>
<div>Office hours: Mon 3-4:30pm</div>
<div style="clear: both;">&nbsp;</div>
</div>
...
<div class="ta-name">Alex Poms</div>
<div>[apoms at cs]</div>
<div class="bold_text">Office hours:</div>
<div>Mon 11am-noon</div>
<div>Location: Smith Hall 234</div>
<div style="clear: both;">&nbsp;</div>
</div>

<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'rmullapu.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
...
<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'thofstee.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
...
<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'junhongl.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
<div class="ta-name">Junhong Li</div>
<div>[junhongl at andrew]</div>
<div class="bold_text">Office hours:</div>
<div>Thu 6-7pm</div>
<div>Location: Gates Collaborative Commons (5th floor)</div>
<div style="clear: both;">&nbsp;</div>
...
<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'yichengf.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
<div class="ta-name">Yicheng Fang</div>
<div>[yichengf at andrew]</div>
<div class="bold_text">Office hours:</div>
<div>Sun 5-6pm</div>
<div>Location: Gates Collaborative Commons (5th floor)</div>
<div style="clear: both;">&nbsp;</div>
...
<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'taoy1.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
<div class="ta-name">Tao Ye</div>
<div>[taoy1 at andrew]</div>
<div class="bold_text">Office hours:</div>
<div>Thu 3-4pm</div>
<div>Location: Gates Collaborative Commons (5th floor)</div>
<div style="clear: both;">&nbsp;</div>
...
<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'assubram.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
<div class="ta-name">Anant Subramanian</div>
<div>[assubram at andrew]</div>
<div class="bold_text">Office hours:</div>
<div>Wed 5-6pm</div>
<div>Location: Gates Collaborative Commons (5th floor)</div>
<div style="clear: both;">&nbsp;</div>
...
<div style="width: 360px; float: left;">
<img src="<?php echo make_url($staff_photos_url, 'rds.jpg'); ?>" width="100" height="100" style="float: left; margin-right: 20px; border: #808080 1px solid;" />
<div class="ta-name">Riya Savla</div>
<div>[rds at andrew]</div>
<div class="bold_text">Office hours:</div>
<div>Fri noon-1pm</div>
<div>Location: Gates Collaborative Commons (5th floor)</div>
<div style="clear: both;">&nbsp;</div>
</div>
...
<p> There is no required textbook for 15-418/618. However, you may find the following textbooks helpful.  However, in general these days there's plenty of great parallel programming resources available for free on the web.</p>
...
15-418/618 Piazza page is located <a href="http://piazza.com/cmu/spring2017/15418618/home" target="_blank">here</a>. The link to sign up for the class on Piazza is <a href="http://piazza.com/cmu/spring2017/15418618">here.</a></p>
