        ...
        <td class="container" width="600">
            <div class="content">
                ...
                <div class="footer">
                    <table width="100%">
                        <tr>
                            <td class="aligncenter content-block">You are receiving this email because you are registered as a student in <a href="<?php echo $site_url?>">15-418, Spring 2015</a>.</td>
                        </tr>
                    </table>
                </div>
            </div>
